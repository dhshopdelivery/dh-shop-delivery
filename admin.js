...
// Empêche le formulaire de recharger la page après la connexion.
...
async function login() {
  ...
  try {
    ...
    */
    ...
    // On charge d'abord le tableau de bord.
    // Ainsi une erreur de chargement ne fait pas disparaître la page de connexion.
    await loadDashboard();
    ...
    console.error("ERREUR CONNEXION / TABLEAU DE BORD :", error);
    ...
    // En cas d'erreur, on garde la connexion visible.
